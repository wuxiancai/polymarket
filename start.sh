...
MIN_PROFIT_USD="${MIN_PROFIT_USD:-1}"
MIN_ROI="${MIN_ROI:-0.01}"
SAFETY_BUFFER_PER_SHARE="${SAFETY_BUFFER_PER_SHARE:-0.002}"
STALE_BOOK_MS="${STALE_BOOK_MS:-5000}"
MAX_SINGLE_TRADE_USD="${MAX_SINGLE_TRADE_USD:-100}"
...
Environment=FEE_BUFFER=${FEE_BUFFER}
Environment=MIN_PROFIT_USD=${MIN_PROFIT_USD}
Environment=MIN_ROI=${MIN_ROI}
Environment=SAFETY_BUFFER_PER_SHARE=${SAFETY_BUFFER_PER_SHARE}
Environment=STALE_BOOK_MS=${STALE_BOOK_MS}
Environment=MAX_SINGLE_TRADE_USD=${MAX_SINGLE_TRADE_USD}
Environment=MAX_OPEN_EXPOSURE_USD=${MAX_OPEN_EXPOSURE_USD}
Environment=MAX_CONSECUTIVE_FAILURES=${MAX_CONSECUTIVE_FAILURES}
